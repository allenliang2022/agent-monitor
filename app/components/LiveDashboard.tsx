  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a1a] to-[#111128] text-slate-200 p-4 md:p-8 space-y-6">
      ...
      >
        ...
        <PromptArchitecturePanel />
      </motion.section>
    </div>
  );
}

// ─── Prompt Architecture Panel ──────────────────────────────────────────────
...
const promptSections = [
  {
    ...
    icon: "🌟",
    color: "purple",
    description: "Agent personality, name, communication style, role definition",
  ...
  },
  {
    ...
    icon: "🧠",
    color: "cyan",
    description: "Long-term MEMORY.md + daily notes + pre-compaction flush + context monitoring",
  ...
  },
  {
    ...
    icon: "🤖",
    color: "amber",
    description: "Multi-agent routing, group chat rules, sub-agent spawning, coding agent delegation",
    files: ["AGENTS.md"],
  },
  {
    id: "skills",
    ...
    icon: "🔧",
    color: "green",
    description: "Skill discovery, SKILL.md loading, tool routing (message/exec/browser/etc.)",
  ...
  },
  {
    ...
    icon: "🔒",
    color: "red",
    description: "No exfiltration, trash > rm, external action approval, injection detection, security audits",
  ...
  },
  {
    ...
    icon: "💡",
    color: "pink",
    description: "Heartbeat checks, reverse prompting, self-healing, context window monitoring, memory maintenance",
...
function PromptArchitecturePanel() {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="lg:col-span-2 space-y-2">
        {promptSections.map((section) => {
          ...
          const borderClass =
            section.color === "purple" ? "border-purple-500/30 bg-purple-500/5" :
            section.color === "cyan" ? "border-cyan-500/30 bg-cyan-500/5" :
            section.color === "amber" ? "border-amber-500/30 bg-amber-500/5" :
            section.color === "green" ? "border-green-500/30 bg-green-500/5" :
            section.color === "red" ? "border-red-500/30 bg-red-500/5" :
            "border-pink-500/30 bg-pink-500/5";
          const defaultBorder = "border-slate-700/50 bg-slate-900/30 hover:border-slate-600";
                    ...
                    >
                      <div className="pt-3 mt-3 border-t border-slate-700/30">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {section.files.map((f) => (
                            <span key={f} className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-800/60 text-slate-400 border border-slate-700/30">
                              {f}
                            </span>
                          ))}
                        </div>
      ...
      <div className="space-y-4">
        <div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
          <h3 className="text-sm font-bold text-amber-400 font-mono mb-3">Operating Rules</h3>
